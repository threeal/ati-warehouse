        ...
        .catch(err => {
          ...
          if (err.response) {
            if (err.response.status === 401) {
              ...
              this.app.log(
                "Detail data muat palet gagal diperbaharui," +
                  ` kesalahan server (${err.response.status})`
              );
            }
          } else {
            this.app.log(
              "Detail data muat palet gagal diperbaharui, tidak ada jaringan"
            );
          }
        });
    },
        ...
        .catch(err => {
          ...
          if (err.response) {
            if (err.response.status === 401) {
              ...
              this.app.log(
                "Gagal mengunduh data muat palet dalam bentuk xlsx," +
                  ` kesalahan server (${err.response.status})`
              );
            }
          } else if (err.request) {
