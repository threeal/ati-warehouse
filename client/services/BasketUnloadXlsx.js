...
class BasketUnloadXlsx {
  ...
  fillWorksheet(worksheet, data) {
    ...
    cell.value =
      "Ware House Section - PT. Aneka Tuna Indonesia Pandaan Factory";
    cell.font = { name: "Arial Narrow", size: 9 };
    ...
    let cells = [worksheet.getCell("A9"), worksheet.getCell("N9")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
    ...
    cells = [worksheet.getCell("A10"), worksheet.getCell("N10")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Mulai\n" },
    ...
    cells = [worksheet.getCell("B10"), worksheet.getCell("Q10")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Selesai\n" },
    ...
    cells = [worksheet.getCell("E9"), worksheet.getCell("R9")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "No. Basket\n" },
    ...
    cells = [worksheet.getCell("F9"), worksheet.getCell("T9")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "ID Basket\n" },
    ...
    cells = [worksheet.getCell("G9"), worksheet.getCell("V9")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Kondisi\n" },
    ...
    cells = [worksheet.getCell("G10"), worksheet.getCell("V10")];
    cells.forEach(cell => {
      cell.value = "Seaming";
      cell.font = { name: "Arial Narrow", size: 10 };
      cell.alignment = {
    ...
    cells = [worksheet.getCell("H10"), worksheet.getCell("W10")];
    cells.forEach(cell => {
      cell.value = "Can Mark";
      cell.font = { name: "Arial Narrow", size: 10 };
      cell.alignment = {
    ...
    cells = [worksheet.getCell("I10"), worksheet.getCell("X10")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Indikator\n" },
    ...
    cells = [worksheet.getCell("J9"), worksheet.getCell("Y9")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Jumlah Tingkat\n" },
    ...
    cells = [worksheet.getCell("K9"), worksheet.getCell("AA9")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Rijek\n" },
    ...
    cells = [worksheet.getCell("K10"), worksheet.getCell("AA10")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Jumlah\n" },
    ...
    cells = [worksheet.getCell("L10"), worksheet.getCell("AB10")];
    cells.forEach(cell => {
      cell.value = {
        richText: [
          { text: "Jenis Rijek\n" },
    ...
    cell.value = {
      richText: [
        ...
        {
          text: "Fill column of Kind of Reject with code: ",
          font: { italic: true }
        },
    ...
    cell.value = {
      richText: [
        ...
        {
          text:
            "Untuk indikator (tidak ada/ hilang dan/ warna tidak berubah)/  "
        },
        {
          text: "For indicator (lost and/or no color changes)",
          font: { italic: true }
        }
      ]
    };
    ...
    cell.value = {
      richText: [
        ...
        {
          text: "Sign of Marked Can Receiver (at Loading Step)",
          font: { italic: true }
        }
      ]
    };
    ...
    cell.value = {
      richText: [{ text: "Unit Head Warehouse" }]
    };
    cell.font = { name: "Arial Narrow", size: 10 };
    cell.alignment = {
      horizontal: "center",
